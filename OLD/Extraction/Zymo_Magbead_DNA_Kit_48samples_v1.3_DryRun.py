...
def run(ctx):
    ...
    # Load tips
    tips1003 = ctx.load_labware('opentrons_flex_96_tiprack_1000ul', 'A2','Tips 4')
    tips1001 = ctx.load_labware('opentrons_flex_96_tiprack_1000ul', 'B2','Tips 2')
    tips1000 = ctx.load_labware('opentrons_flex_96_tiprack_1000ul', 'B3','Tips 1')
    tips1004 = ctx.load_labware('opentrons_flex_96_tiprack_1000ul', 'A1','Tips 5')
