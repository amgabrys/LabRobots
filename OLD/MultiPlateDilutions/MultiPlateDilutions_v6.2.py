## MULTIPLE PLATE DILUTIONS V6.2 - NO SAMPLE PIPETTE MIXING

from opentrons import protocol_api
import math

metadata = {
    'protocolName': 'Multiple Plate Dilutions V6.2: NO SAMPLE MIXING',
    'author': 'OpentronsAI',
    'description': 'Dilute samples from multiple plates, withOUT sample pipette mixing',
    'source': 'OpentronsAI'
}
