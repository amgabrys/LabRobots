...
# Figure out how to add numeric parameter for input sample volume (assuming all have the same volume)
# Or could add it to the csv file
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    for row in well_data:
        ...
        # Mix source sample. 
        p20_single.mix(3, 18, source_plate[source_well]) # Mix 3 times, 18 ul
