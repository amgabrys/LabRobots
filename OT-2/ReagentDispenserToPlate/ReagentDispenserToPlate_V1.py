...
def run(protocol: protocol_api.ProtocolContext):
    ...
    # ============================================================================
    well_total_volumes = {}  # {well_name: total_volume}
    ...
    for reagent_name in reagent_list:
        ...
        for well_name, volume in wells_to_fill.items():
            ...
            if volume > 20:
                ...
                p20.blow_out(dest_well.top(z=-2))
            # Mix in well if specified - USING TOTAL VOLUME
            if mix_after > 0:
                # Calculate mix volume based on TOTAL volume in well (80% of total, max 18µL, min 2µL)
